...
--------------------------------------------------------------------------------
## Collision precision
A paper on my hash collision calculator for any file or range of files, (tells you exactly how many different files of what size correspond to a hash of particular possibilities) and on generating hash without collision or reversal shortcuts--a variable Authorship function of special inconvenience. (Completed, electronifying...)
